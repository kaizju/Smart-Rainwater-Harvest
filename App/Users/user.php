...
<body>
    <div class="container-xl">
        ...
        <?php endif; ?>
        <a href="<?php echo BASE_URL; ?>/App/Dashboard/dashboard.php"> <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
